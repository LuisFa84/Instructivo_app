...
.method private recalculateBarSpaceAndWidth()V
    ...
    iput v2, p0, Lcom/google/appinventor/components/runtime/BarChartView;->barSpace:F
    ...
    invoke-virtual {v2, v4}, Lcom/github/mikephil/charting/components/XAxis;->setCenterAxisLabels(Z)V
...
.method private regroupBars()V
    ...
    iget v4, p0, Lcom/google/appinventor/components/runtime/BarChartView;->barSpace:F

    invoke-virtual {v3, v6, v7, v4}, Lcom/github/mikephil/charting/charts/BarChart;->groupBars(FFF)V

    .line 167
    const/4 v2, 0x0

    .line 169
    .local v2, "maxEntries":I
    iget-object v3, p0, Lcom/google/appinventor/components/runtime/BarChartView;->chart:Lcom/github/mikephil/charting/charts/Chart;
    ...
    .line 174
    .end local v0    # "dataSet":Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;
    :cond_46
    iget-object v3, p0, Lcom/google/appinventor/components/runtime/BarChartView;->chart:Lcom/github/mikephil/charting/charts/Chart;
    ...
    invoke-virtual {v3, v6}, Lcom/github/mikephil/charting/components/XAxis;->setAxisMinimum(F)V
    ...
    invoke-virtual {v3, v7, v5}, Lcom/github/mikephil/charting/data/BarData;->getGroupWidth(FF)F
    ...
    .line 179
    invoke-virtual {v4, v3}, Lcom/github/mikephil/charting/components/XAxis;->setAxisMaximum(F)V

    .line 182
    .end local v2    # "maxEntries":I
    :cond_6f
    return-void
.end method
...
.method protected refresh(Lcom/google/appinventor/components/runtime/ChartDataModel;Ljava/util/List;)V
    ...
    .end local v0    # "dataset":Lcom/github/mikephil/charting/interfaces/datasets/IBarDataSet;
    invoke-virtual {v0, p2}, Lcom/github/mikephil/charting/data/BarDataSet;->setValues(Ljava/util/List;)V
